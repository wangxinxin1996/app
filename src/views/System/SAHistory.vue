  ...
  <div>
    ...
    <template>
      <el-table :data="tempData.slice((currentPage-1)*pagesize,currentPage*pagesize)" stripe style="width: 100%">
        ...
        <el-table-column prop="date" label="检测时间" width="160px"></el-table-column>
      </el-table>
    </template>
        ...
        .then(res => {
          ...
          res.data.forEach(enterprise => {
            enterprise.device.forEach(device => {
               this.Len =device.lampblackInfoList.length;
              ...
              device.lampblackInfoList.forEach(lampblackInfo => { 
                this.tableData.push({
                  ...
                  // 风量
                  airVolume: lampblackInfo.airVolume,
                  // 风速
                  weedSpeed: lampblackInfo.weedSpeed,
                  //动压
                  dynPressure:lampblackInfo.dynPressure,
                  // 静压
                  staticPressure:lampblackInfo.staticPressure,
                  // 风机
